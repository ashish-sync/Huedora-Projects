...
import ContactDirectoryPage from '../document-one/ContactDirectoryPage.jsx';
import DocumentMasterPage from '../document-one/DocumentMasterPage.jsx';
import SignatureMasterPage from '../document-one/SignatureMasterPage.jsx';
...
const MASTER_GROUPS = [
  ...
  },
  {
    ...
    entities: [
      ...
      { id: 'pin-codes', label: 'PIN Geography', embedded: 'pin-codes', fields: [] },
    ],
  },
];
