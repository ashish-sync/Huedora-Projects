...
export const FINANCE_PATH = {
  ...
  DEBIT_NOTE: `${MODULE_PATH.FINANCE_ONE}/billing/debit-note`,
  DELIVERY_CHALLAN: `${MODULE_PATH.FINANCE_ONE}/billing/delivery-challan`,
  BILL_OF_SUPPLY: `${MODULE_PATH.FINANCE_ONE}/billing/bill-of-supply`,
  QUOTATION: `${MODULE_PATH.FINANCE_ONE}/billing/quotation`,
...
export const LEGACY_PATH_REDIRECTS = [
  ...
  ['/finance/build/debit-note', FINANCE_PATH.DEBIT_NOTE],
  ['/finance/build/delivery-challan', FINANCE_PATH.DELIVERY_CHALLAN],
  ['/finance/build/bill-of-supply', FINANCE_PATH.BILL_OF_SUPPLY],
  ['/finance/build/quotation', FINANCE_PATH.QUOTATION],
